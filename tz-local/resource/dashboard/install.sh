...
#KubeDNS is running at https://192.168.2.10:6443/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
...
cd /Volumes/sambashare/tz-k8s-elk  # shared folder
security add-trusted-cert \
  -r trustRoot \
  -k "/Users/dhong/Library/Keychains/login.keychain" \
  ./ca.crt    # under tz-k8s-elk folder
